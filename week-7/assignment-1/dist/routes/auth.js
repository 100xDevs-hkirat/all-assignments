...
router.post('/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUsernameValid = input_1.Username.safeParse(userInput.username);
    const isPasswordValid = input_1.Password.safeParse(userInput.password);
    ...
    const user = yield db_1.User.findOne({ username: userInput.username });
    if (user) {
