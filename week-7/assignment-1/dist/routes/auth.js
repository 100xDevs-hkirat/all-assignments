...
router.post('/signup', schemaValidation_1.userCredentialsSchemaValidation, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        ...
        const newUser = new index_2.User({ username: input.username, password: input.password });
        yield newUser.save();
        const token = jsonwebtoken_1.default.sign({ id: newUser._id }, index_1.SECRET, { expiresIn: '1h' });
        res.json({ message: 'User created successfully', token });
    }
}));
router.post('/login', schemaValidation_1.userCredentialsSchemaValidation, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const input = req.body;
