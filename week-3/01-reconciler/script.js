...
deleteTodo = (id) =>{
  ...
  fetch("http://localhost:3000/todos/" + id, {
      ...
      const response = resp;
      if(response.status === 200) alert(`Record with id ${id} has been deleted successfully!`);
      var parElement = document.getElementById('mainArea');
      parElement.removeAttribute();
  });
  }
