...
const purchasePath = path.join(__dirname, "./PURCHASED_COURSES.json");
...
readfile(purchasePath)
  .then((data) => {
    PURCHASED_COURSES = data;
  })
  .catch((err) => console.log(err));
...
app.post("/admin/signup", (req, res) => {
  ...
  if (isUsername) {
    ...
    writefile(adminPath, JSON.stringify(ADMINS, null, 2));
...
app.post("/admin/courses", (req, res) => {
  ...
  if (!foundAdmin) {
    ...
    writefile(coursePath, JSON.stringify(COURSES, null, 2));
    res
      .status(201)
...
app.post("/users/signup", (req, res) => {
  ...
  if (isUsername) {
    ...
    writefile(userPath, JSON.stringify(USERS, null, 2));
...
app.post("/users/courses/:courseId", (req, res) => {
  ...
  if (!foundUser) {
    ...
    if (!purchase_course) {
      ...
      writefile(purchasePath, JSON.stringify(PURCHASED_COURSES, null, 2));
