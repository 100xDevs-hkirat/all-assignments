...
let ADMINS = JSON.parse(readFile("./files/admins.json"));
let USERS = JSON.parse(readFile("./files/users.json"));
let COURSES = JSON.parse(readFile("./files/courses.json"));
...
app.post("/admin/signup", (req, res) => {
  ...
  if (usernameFound) {
    ...
    writeFile("./files/admins.json", ADMINS);
...
app.post("/admin/courses", authJwt, (req, res) => {
  ...
  writeFile("./files/courses.json", COURSES);
...
app.post("/users/signup", (req, res) => {
  ...
  if (userExist) {
    ...
    writeFile("./files/users.json", USERS);
    const token = generateJwt(username);
