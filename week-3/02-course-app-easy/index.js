...
function authenticateAdmin(req, res, next) {
  ...
  else if (admin.password !== req.headers.password) res.status(401).send('Invalid Password');
  else next();
}
...
app.post('/admin/login', checkUsernamePasswordValidityHeader, authenticateAdmin, (req, res) => {
