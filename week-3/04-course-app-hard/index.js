...
// connct to mongodb through url
mongoose.connect(
  "mongodb+srv://zahid:zahid495@cluster0.t7uye72.mongodb.net/courses",
  {
...
app.post("/admin/signup", async (req, res) => {
  ...
  if (admin) res.send(403).json({ message: "Admin already exist" });
  else {
