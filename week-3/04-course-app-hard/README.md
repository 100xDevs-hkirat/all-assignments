# Course Selling API
This repo contains API that store files in MongoDB. Follow the instructions to setup the project locally
...
`DATABASE` - Should be of type `mongodb+srv://username:<PASSWORD>@clustername.mongodb.net/database-name`

Example - `mongodb+srv://user1:<PASSWORD>@cluster0.6hgbrf.mongodb.net/courses`

`DATABASE_PASSWORD` Should be defined separately
