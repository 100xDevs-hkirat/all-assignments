...
function Course({ title, description, price, imageLink ,onClick}) {
  return (
    <Card onClick={onClick} style={{ cursor: 'pointer', marginBlock: '.5rem', display: 'flex', backgroundColor: '#22D1EE', width: '45%' }}>
